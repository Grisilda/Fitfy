...
if(mysqli_num_rows ($data)!=0){
	...
	<a href="https://fitfy.000webhostapp.com/user/email/html/restoreAccount.html" style="background-color: #f34e3a;
	...
	if(!$mail->send()){
	    ...
	    header("Location: https://fitfy.000webhostapp.com/user/email/html/restor.html");
	    echo "Message sent!";
	}
